...
function showCharacter(character) {
   const html = /* html */ `
        <article class="character-grid-item">
            ...
            <p>Item Lvl ${character.itemLevel}<p>
            <p>${character.battletag}, ${character.country}<p>
            ${isActive(character)}
   ...
   document.querySelector("#characters article:last-child .btn-delete-character").addEventListener("click", () => deleteClicked(character));
...
document.querySelector("#sort-level-button").addEventListener("click", sortCharactersByLevel);
document.querySelector("#sort-ilvl-button").addEventListener("click", sortCharactersByIlvl);
