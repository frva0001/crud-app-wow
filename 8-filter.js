...
async function filterLeveling() {
   ...
   const leveledCharacters = characters.filter((character) => character.activities.leveling);
...
async function filterQuesting() {
   ...
   const questingCharacters = characters.filter((character) => character.activities.questing);
...
async function filterMythicPlus1() {
   ...
   const mythicPlus1Characters = characters.filter((character) => character.activities.mythicPlus1);
...
async function filterMythicPlus2() {
   ...
   const mythicPlus2Characters = characters.filter((character) => character.activities.mythicPlus2);
...
async function filterMythicPlus3() {
   ...
   const mythicPlus3Characters = characters.filter((character) => character.activities.mythicPlus3);
...
async function filterMythicPlus4() {
   ...
   const mythicPlus4Characters = characters.filter((character) => character.activities.mythicPlus4);
...
async function filterRaid1() {
   ...
   const raid1Characters = characters.filter((character) => character.activities.raid1);
...
async function filterRaid2() {
   ...
   const raid2Characters = characters.filter((character) => character.activities.raid2);
...
async function filterRaid3() {
   ...
   const raid3Characters = characters.filter((character) => character.activities.raid3);
...
async function filterPVP1() {
   ...
   const pvp1Characters = characters.filter((character) => character.activities.pvp1);
...
async function filterPVP2() {
   ...
   const pvp2Characters = characters.filter((character) => character.activities.pvp2);
...
async function filterTransmogAndMounts() {
   ...
   const transmogAndMountsCharacters = characters.filter((character) => character.activities.transmogAndMounts);
